...
import static com.quotesin.quotesin.activities.CountryService.chkAllCity;
...
public class CityAdapter extends RecyclerView.Adapter<CityAdapter.ViewHolder> {
    ...
    public CityAdapter(FragmentActivity activity, ArrayList<CitiesModel> stateArrayList) {
    ...
    public void onBindViewHolder(final CityAdapter.ViewHolder holder, int i) {
